...
unpackLevelSpeci
  :: (Monad m)
  => Int
  -- ^ Default level (will be used when the second argument is empty).
  -> [LispVal]
  -- ^ Level specification to be unpacked, could be empty, or taken as n, {n}, {i, j}.
